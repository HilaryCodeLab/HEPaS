...
DROP DATABASE IF EXISTS OSCLR;
CREATE DATABASE IF NOT EXISTS OSCLR;
USE OSCLR;

    CREATE TABLE IF NOT EXISTS courses
(
	course_code VARCHAR(3) PRIMARY KEY NOT NULL,
	course_title VARCHAR(50) NOT NULL,
	year_start_offer VARCHAR(4) NOT NULL,
    year_end_offer VARCHAR(4),
	course_coordinator_name VARCHAR(50),
...
(
    	...
    	unit_code VARCHAR(512),
    	unit_title VARCHAR(512),
		score FLOAT NOT NULL,
    	result_grade VARCHAR(2),
		FOREIGN KEY (student_id) REFERENCES students(student_id)
);
INSERT INTO courses (course_code, course_title, year_start_offer, year_end_offer, course_coordinator_name, coordinator_email, coordinator_mobile_no) VALUES
	('U65', 'Computer Science', '1989', 'Nil', 'Course_cor1 PERSON1', 'cc.PERSON1@my.oust.edu.au', '2024010201'),
	('U67', 'Information Technology', '1992', 'Nil', 'Course_cor2 PERSON2', 'cc.PERSON2@my.oust.edu.au', '2024010202'),
	('Y89', 'Cyber Security', '1998', 'Nil', 'Course_cor3 PERSON3', 'cc.PERSON3@my.oust.edu.au', '2024010203'),
	('Y84', 'Data Science', '2012', 'Nil', 'Course_cor4 PERSON14', 'cc.PERSON14@my.oust.edu.au', '2024010204'),
	('K22', 'Physics', '1983', 'Nil', 'Course_cor5 PERSON62', 'cc.PERSON62@my.oust.edu.au', '2024010205'),
	('E37', 'Tertiery Education ', '1983', '2022', 'Nil', 'Nil', 'Nil');
    
INSERT INTO students (student_id, first_name, last_name, oust_email, mobile_no, course_code, units_attempted, units_completed, course_status) VALUES
	( '20241201', 'Jim', 'Max', 'j.max@our.oust.edu.au', '2024120201', 'U65', '30', '24', 'Completed'),
	( '20241202', 'Jit', 'Max', 'jt.max@our.oust.edu.au', '2024120202', 'U65', '24', '24', 'Completed'),
	( '20241203', 'Late', 'Max', 'l.max@our.oust.edu.au', '2024120203', 'U65', '28', '24', 'Completed'),
	( '20241204', 'Rep', 'Smith', 'r.smith@our.oust.edu.au', '2024120204', 'U65', '26', '24', 'Completed'),
	( '20241205', 'Paul', 'Landan', 'p.landan@our.oust.edu.au', '2024120205', 'U67', '27', '24', 'Completed'),
	( '20241206', 'Peter', 'London', 'p.london@our.oust.edu.au', '2024120206', 'U67', '26', '24', 'Completed'),
	( '20241207', 'John', 'Turner', 'j.turner@our.oust.edu.au', '2024120207', 'Y84', '27', '24', 'Completed'),
	( '20241208', 'Jim', 'Xiao', 'j.xiao@our.oust.edu.au', '2024120208', 'Y84', '17', '15', 'In Progress');
    
INSERT INTO unit_scores (record_No, student_id, unit_code, unit_title, score, result_grade) VALUES
	('101', '20241201', 'Unit_01', 'Unit_title_001', '100', 'HD'),
	...
	('201', '20241202', 'Unit_01', 'Unit_title_001', '74', 'D'),
	...
	('301', '20241203', 'Unit_01', 'Unit_title_001', '22.2', 'F'),
	...
	('401', '20241204', 'Unit_01', 'Unit_title_001', '71.6', 'D'),
	...
	('501', '20241205', 'Unit_01', 'Unit_title_001', '70', 'D'),
	...
	('601', '20241206', 'Unit_01', 'Unit_title_001', '65.9', 'CR'),
	('602', '20241206', 'Unit_02', 'Unit_title_002', '52.6', 'P'),
	('603', '20241206', 'Unit_03', 'Unit_title_003', '61.9', 'CR'),
	('604', '20241206', 'Unit_04', 'Unit_title_004', '53.1', 'P'),
	('605', '20241206', 'Unit_05', 'Unit_title_005', '51.5', 'P'),
	('606', '20241206', 'Unit_07', 'Unit_title_007', '55.4', 'P'),
	('607', '20241206', 'Unit_08', 'Unit_title_008', '62.5', 'CR'),
	('608', '20241206', 'Unit_10', 'Unit_title_010', '64.4', 'CR'),
	('609', '20241206', 'Unit_41', 'Unit_title_041', '50.7', 'P'),
	('610', '20241206', 'Unit_42', 'Unit_title_042', '54.4', 'P'),
	('611', '20241206', 'Unit_43', 'Unit_title_043', '62.7', 'CR'),
	('612', '20241206', 'Unit_44', 'Unit_title_044', '56.4', 'P'),
	('613', '20241206', 'Unit_45', 'Unit_title_045', '50.5', 'P'),
	('614', '20241206', 'Unit_46', 'Unit_title_046', '80.5', 'HD'),
	('615', '20241206', 'Unit_48', 'Unit_title_048', '62.7', 'CR'),
	('616', '20241206', 'Unit_49', 'Unit_title_049', '57.8', 'P'),
	('617', '20241206', 'Unit_60', 'Unit_title_060', '71.2', 'D'),
	('618', '20241206', 'Unit_61', 'Unit_title_061', '55.7', 'P'),
	('619', '20241206', 'Unit_62', 'Unit_title_062', '51.1', 'P'),
	('620', '20241206', 'Unit_63', 'Unit_title_063', '41', 'F'),
	('621', '20241206', 'Unit_63', 'Unit_title_063', '62.7', 'CR'),
	('622', '20241206', 'Unit_66', 'Unit_title_066', '56.3', 'P'),
	('623', '20241206', 'Unit_67', 'Unit_title_067', '60', 'CR'),
	('624', '20241206', 'Unit_68', 'Unit_title_068', '54.5', 'P'),
	('625', '20241206', 'Unit_69', 'Unit_title_069', '47.5', 'F'),
	('626', '20241206', 'Unit_69', 'Unit_title_069', '58.2', 'P'),
	('701', '20241207', 'Unit_01', 'Unit_title_001', '50.1', 'P'),
	('702', '20241207', 'Unit_02', 'Unit_title_002', '56.8', 'P'),
	('703', '20241207', 'Unit_03', 'Unit_title_003', '58.4', 'P'),
	('704', '20241207', 'Unit_04', 'Unit_title_004', '62.6', 'CR'),
	('705', '20241207', 'Unit_05', 'Unit_title_005', '58.4', 'P'),
	('706', '20241207', 'Unit_06', 'Unit_title_006', '83.9', 'HD'),
	('707', '20241207', 'Unit_07', 'Unit_title_007', '52.1', 'P'),
	('708', '20241207', 'Unit_08', 'Unit_title_008', '48.3', 'F'),
	('709', '20241207', 'Unit_08', 'Unit_title_008', '64.2', 'CR'),
	('710', '20241207', 'Unit_70', 'Unit_title_070', '68.9', 'CR'),
	('711', '20241207', 'Unit_71', 'Unit_title_071', '69.3', 'CR'),
	('712', '20241207', 'Unit_72', 'Unit_title_072', '79.6', 'D'),
	('713', '20241207', 'Unit_73', 'Unit_title_073', '70.9', 'D'),
	('714', '20241207', 'Unit_74', 'Unit_title_074', '71.2', 'D'),
	('715', '20241207', 'Unit_75', 'Unit_title_075', '78', 'D'),
	('716', '20241207', 'Unit_76', 'Unit_title_076', '48', 'F'),
	('717', '20241207', 'Unit_76', 'Unit_title_076', '76.8', 'D'),
	('718', '20241207', 'Unit_79', 'Unit_title_079', '60', 'CR'),
	('719', '20241207', 'Unit_80', 'Unit_title_080', '61', 'CR'),
	('720', '20241207', 'Unit_81', 'Unit_title_081', '36.1', 'F'),
	('721', '20241207', 'Unit_81', 'Unit_title_081', '62', 'CR'),
	('722', '20241207', 'Unit_84', 'Unit_title_084', '78.5', 'D'),
	('723', '20241207', 'Unit_85', 'Unit_title_085', '76.8', 'D'),
	('724', '20241207', 'Unit_86', 'Unit_title_086', '53', 'P'),
	('725', '20241207', 'Unit_88', 'Unit_title_088', '60.6', 'CR'),
	('726', '20241207', 'Unit_89', 'Unit_title_089', '75.2', 'D'),
	('727', '20241207', 'Unit_90', 'Unit_title_090', '63.1', 'CR'),
	('801', '20241208', 'Unit_01', 'Unit_title_001', '54', 'P'),
	('802', '20241208', 'Unit_02', 'Unit_title_002', '92.1', 'HD'),
	('803', '20241208', 'Unit_03', 'Unit_title_003', '72.3', 'D'),
	('804', '20241208', 'Unit_04', 'Unit_title_004', '34.5', 'F'),
	('805', '20241208', 'Unit_04', 'Unit_title_004', '53', 'P'),
	('806', '20241208', 'Unit_06', 'Unit_title_006', '56.4', 'P'),
	('807', '20241208', 'Unit_07', 'Unit_title_007', '98.6', 'HD'),
	('808', '20241208', 'Unit_08', 'Unit_title_008', '56.7', 'P'),
	('809', '20241208', 'Unit_09', 'Unit_title_009', '67', 'CR'),
	('810', '20241208', 'Unit_70', 'Unit_title_070', '42.2', 'F'),
	('811', '20241208', 'Unit_70', 'Unit_title_070', '51.2', 'P'),
	('812', '20241208', 'Unit_72', 'Unit_title_072', '92.9', 'HD'),
	('813', '20241208', 'Unit_73', 'Unit_title_073', '77.1', 'D'),
	('814', '20241208', 'Unit_74', 'Unit_title_074', '71.5', 'D'),
	('815', '20241208', 'Unit_87', 'Unit_title_087', '97.7', 'HD'),
	('816', '20241208', 'Unit_89', 'Unit_title_089', '61.2', 'CR'),
	('817', '20241208', 'Unit_90', 'Unit_title_090', '99.9', 'HD');